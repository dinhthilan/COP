...
s = 1.5
print('s = ',s)
val_star,x_star,val,x,FEAS2,VAL2 = utils.run(A,b,x0,v,lambd,m,func.eval_f0,func.eval_f_ineq,
                 Print=True,history=True,delta=1,rho=1,s = s,numiter=Numiter,eps=0.001)
print('-'*20)
