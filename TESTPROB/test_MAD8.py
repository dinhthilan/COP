# -*- coding: utf-8 -*-
"""
Created on Mon Dec 21 14:28:17 2020
...
def obj_new(x):
    val,grad=mad8.obj(x.reshape(n,1))
    return val,grad.reshape(n,)

def cons_new(x):
    vec_val,mat_grad=mad8.cons(x.reshape(n,1))
...
s=1
print('s = ',s)
_,_,_,_,FEAS4,VAL4 = PDS.run(A,b,x0,v,lambd,m,mad8.obj,mad8.cons,
...
s=1.5
print('s = ',s)
_,_,_,_,FEAS5,VAL5 = PDS.run(A,b,x0,v,lambd,m,mad8.obj,mad8.cons,
                 Print=True,history=True,delta=delta,rho=1/s,s =s,numiter=numiter,
                 eps=eps)
...
s=2
print('s = ',s)
_,_,_,_,FEAS6,VAL6 = PDS.run(A,b,x0,v,lambd,m,mad8.obj,mad8.cons,
                 Print=True,history=True,delta=delta,rho=1/s,s =s,numiter=numiter,
                 eps=eps)
